...
# 1. Load your data
print("Loading data...")
df = pd.read_csv('/Users/kushalprakash/Desktop/UNI/Thesis/ThesisPrj/Anomaly_detection_synthetic_Combined/Training_data/merged_training_dataset_Combined.csv')
...
history = autoencoder.fit(
    ...
    callbacks=[LossThreshold(0.001), csv_logger],
    verbose=1
)
end_time = time.time()
