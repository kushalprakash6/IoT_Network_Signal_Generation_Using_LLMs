...
# Configuration
# =========================
csv_file = "/data/resources/prakash/work/Qwen_IEEE/benign_IoT.csv"           # Path to your CSV file
output_dir = "./Qwen_IEEE/model_output_qwen_IEEE"   # Where to save model and tokenizer
